#' HC Sequential Color Palette
#'
#' Commonly used default colors from visualization guide
#'
#' @export

hc_sequential <- c("#c6e8fb", "#88bfe7", "#4895c8", "#22689a", "#113c66", "#dbcae3", "#bfa2cd", "#9e76b4", "#745195", "#543079")

#' HC Categorical Color Palette.
#'
#' Commonly used default colors from visualization guide
#'
#' @export
