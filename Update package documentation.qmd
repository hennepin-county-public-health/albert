...
In addition, when I use code to other packages I add them as dependencies to albert using this code. This will add it under "imports" in the DESCRIPTION file.
...
deps <- c("dplyr", 
          ...
          "rvest", #flag_nicknames; not part of the core tidyverse
          
          "AzureAuth", #adls functions
          "AzureStor", #adls functions
          "arrow" #adls functions
          )

for (d in deps){
  usethis::use_package(d)
}
```
